...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 39845888;
...
assert(INITIAL_MEMORY == 39845888, "Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically");
...
function _DownloadImageJS(base64Image) {
 var image = new Image();
 image.src = "data:image/png;base64," + UTF8ToString(base64Image);
...
function _ShareImageJS(base64Image) {
 var image = new Image();
 image.src = "data:image/png;base64," + UTF8ToString(base64Image);
 if (navigator.share) {
...
var asmLibraryArg = {
 "DetectDeviceJS": _DetectDeviceJS,
 "DownloadImageJS": _DownloadImageJS,
